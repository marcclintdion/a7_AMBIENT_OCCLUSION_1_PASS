...
"    highp float OCCLUSION = originalPixel.x;                                                                             \n"


"    gl_FragColor         =  vec4(OCCLUSION)*vec4(OCCLUSION)*vec4(OCCLUSION);                                                                                                             \n"
